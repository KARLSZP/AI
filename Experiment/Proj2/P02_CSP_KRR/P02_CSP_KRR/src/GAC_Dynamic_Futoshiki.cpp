...
// Define the Max SIZE of the chessboard.
...
struct Do {
    ...
    int curdom[MSIZE+1];        // curdom[1] to curdom[SIZE]: 1 for {INVALID}, 0 for {VALID}.
...
// The futoshiki game.
struct futoshiki {
    Do board[MSIZE+1][MSIZE+1];               // The chessboard.
...
// 1. Initialization
    ...
    cout << "\n>>> Please Input the Size of the board:" << endl;
    cout << "\nE.g.: Board - 8x8 - Please input [8]." << endl;
    cin >> SIZE;
    futoshiki FTSK;
    futoshiki* ptr = &FTSK;
